...
purchaseRoutes.post('/create', validate(createPurchaseValidation, {}, {keyByField: true, context: false}), authMiddleware.jwtValidation, PurchaseController.create.bind(PurchaseController));
